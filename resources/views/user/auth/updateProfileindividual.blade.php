            ...
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    @isset($user)
                        ...
                        <form action="{{ route('updateIndividual') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" type="text" value="{{ $user->Title }}" name="Title" placeholder="Title">
                                    @if ($errors->has('Title'))
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" type="date"  value="{{ $user->DOB }}" name="DOB" placeholder="Journal Name">
                                    @if ($errors->has('DOB'))
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <select name="TaxResidence" class="select2 form-control mb-3 custom-select"
                                        ...
                                        <option value="{{ $user->TaxResidence }}">{{ $user->TaxResidence }}</option>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <select name="CountryResidence" class="select2 form-control mb-3 custom-select"
                                        style="width: 100%; height:36px;">
                                        <option value="{{ $user->CountryResidence }}">{{ $user->CountryResidence }}</option>
                                        <option value="Afganistan">Afghanistan</option>
                                        <option value="Albania">Albania</option>
                                        <option value="Algeria">Algeria</option>
                                        <option value="American Samoa">American Samoa</option>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <select name="PrimaryCitizenship" class="select2 form-control mb-3 custom-select"
                                        style="width: 100%; height:36px;">
                                        <option value="{{ $user->PrimaryCitizenship }}">{{ $user->PrimaryCitizenship }}</option>
                                        <option value="Afganistan">Afghanistan</option>
                                        <option value="Albania">Albania</option>
                                        <option value="Algeria">Algeria</option>
                                        <option value="American Samoa">American Samoa</option>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" type="text" value="{{ $user->MAILINGADDRESS }}"  name="MAILINGADDRESS"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" type="text" value="{{ $user->Addressline1 }}"  name="Addressline1"
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" type="text" value="{{ $user->Addressline2 }}"  name="Addressline2"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" type="text" value="{{ $user->City }}" name="City" placeholder="Enter City / Town">
                                    @if ($errors->has('City'))
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" value="{{ $user->Zip }}" type="number"  name="Zip"
