    ...
    <div class="row">
        <div class="col-lg-6 col-md-12 col-sm-12 offset-lg-3 offset-md-3" style="margin-top: 50px">
            <div class="card m-b-30">
                <div class="card-body">
                    <h4 class="header-title mt-0">Update Company Profile</h4>
                    @isset($user)
                        ...
                        <form action="{{ route('UpdateCompany') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input  class="form-control" value="{{ $user->Phone }}" type="number" name="Phone" placeholder="Enter Phone">
                                    @if ($errors->has('Phone'))
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input  class="form-control" type="text" value="{{ $user->CompanyName }}" name="CompanyName" placeholder="Enter Company Name">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input class="form-control" type="file"  value="{{ $user->CompanyLogo }}" name="CompanyLogo" placeholder="">
                                    @if ($errors->has('CompanyLogo'))
                                        <span class="text-danger">{{ $errors->first('CompanyLogo') }}</span>
                                    @endif
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <label for="">Publicly listed company?</label>
                                    <select  name="listed" class="select2 form-control mb-3 custom-select"
                                        style="width: 100%; height:36px;">
                                        <option value="{{ $user->listed }}">{{ $user->listed }}</option>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input  class="form-control" value="{{ $user->RegistrationNumber }}" type="text" name="RegistrationNumber"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <label for="">Incorporation country</label>
                                    <select name="IncorporationCountry" class="select2 form-control mb-3 custom-select"
                                        style="width: 100%; height:36px;">
                                        
                                        <option value="{{ $user->IncorporationCountry }}">{{ $user->IncorporationCountry }}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <label for="">Principle business</label>
                                    <select  name="PrincipleBusiness" class="select2 form-control mb-3 custom-select"
                                        style="width: 100%; height:36px;">
                                        
                                        <option value="{{ $user->PrincipleBusiness }}">{{ $user->PrincipleBusiness }}</option>
                                        <option value="Renewable Energy Developer">Renewable Energy Developer</option>
                                    ...
                                    @if ($errors->has('PrincipleBusiness'))
                                        <span class="text-danger">{{ $errors->first('PrincipleBusiness') }}</span>
                                    @endif
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <label for="">Company general email</label>
                                    <input  class="form-control" value="{{ $user->CompanyEmail }}" type="text" name="CompanyEmail"
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <label for="">Company general website</label>
                                    <input  class="form-control" value="{{ $user->CompanyWebsite }}"  type="text" name="CompanyWebsite" placeholder="https://website.com">
                                </div>
                                @if ($errors->has('CompanyWebsite'))
                                    <span class="text-danger">{{ $errors->first('CompanyWebsite') }}</span>
                                @endif
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <label for="">Mailing Address Data</label>
                                    <input  class="form-control" value="{{ $user->MailingAddress }}" type="text" name="MailingAddress"
                                        placeholder="Enter Mailing Address Data">
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <label for="">Primary source of business income?</label>
                                    <select name="income" class="select2 form-control mb-3 custom-select"
                                        style="width: 100%; height:36px;">
                                        <option value="{{ $user->income }}">{{ $user->income }}</option>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    <label for="">Is this company a Professional Investor?</label>
                                    <select  name="Investor"  class="select2 form-control mb-3 custom-select"
                                        style="width: 100%; height:36px;">
                                        <option value="{{ $user->Investor }}">{{ $user->Investor }}</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input  class="form-control"   value="{{ $user->Addressline1 }}" type="text" name="Addressline1"
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input  class="form-control" value="{{ $user->City }}" type="text" name="City" placeholder="Enter City / Town">
                                </div>
                                @if ($errors->has('City'))
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input  class="form-control"  value="{{ $user->Zip }}" type="number" name="Zip" placeholder="Enter Zip / Postal code">
                                </div>
                                @if ($errors->has('Zip'))
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input  class="form-control" value="{{ $user->State }}" type="text" name="State"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12">
                                    ...
                                    <input  class="form-control"  type="file" name="Incorporation" placeholder="Incorporation"
                                        multiple>
                                </div>
