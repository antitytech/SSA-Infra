        ...
        <div class="col-lg-6 col-md-12 col-sm-12 offset-lg-3 offset-md-3" style="margin-top: 50px">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <form action="{{ route('updateCompanyProfile') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="email" placeholder="Enter Your Email"
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="number" name="Phone" placeholder="Enter Phone">
                                @if ($errors->has('Phone'))
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="CompanyName" placeholder="Enter Company Name">
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="file" name="CompanyLogo" placeholder="">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select required name="listed" class="select2 form-control mb-3 custom-select"
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="RegistrationNumber"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select required name="IncorporationCountry" class="select2 form-control mb-3 custom-select"
                                    style="width: 100%; height:36px;">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select required name="PrincipleBusiness" class="select2 form-control mb-3 custom-select"
                                    style="width: 100%; height:36px;">
                                    <option value="">Select an option</option>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="CompanyEmail"
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="CompanyWebsite" placeholder="https://website.com">
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="MailingAddress"
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select required name="income" class="select2 form-control mb-3 custom-select"
                                    style="width: 100%; height:36px;">
                                    <option value="">Select an option</option>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select required name="Investor" class="select2 form-control mb-3 custom-select"
                                    style="width: 100%; height:36px;">
                                    <option value="">Select an option</option>
                                    <option value="Yes">Yes</option>
                                    <option value="No">No</option>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="Addressline1"
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="City" placeholder="Enter City / Town">
                            </div>
                            @if ($errors->has('City'))
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="text" name="Zip" placeholder="Enter Zip / Postal code">
                            </div>
                            @if ($errors->has('Zip'))
                        ...
                        <div class="form-group row">
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <select required name="Country" class="select2 form-control mb-3 custom-select"
                                    style="width: 100%; height:36px;">
                                    <option value="">Select an option</option>
                                    <option value="Afganistan">Afghanistan</option>
                                    <option value="Albania">Albania</option>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <input required class="form-control" type="file" name="Incorporation" placeholder="Incorporation"
                                    multiple>
                            </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            ...
                            <select required name="ROLES" class="select2 form-control mb-3 custom-select"
                                style="width: 100%; height:36px;">
                                <option value="">Select an option</option>
