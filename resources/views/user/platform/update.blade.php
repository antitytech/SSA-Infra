        ...
        <div class="col-lg-12 col-md-12 col-sm-12 " style="margin-top: 50px">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <form action="{{ route('update_platforms') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                           <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <textarea class="form-control" type="text" name="OpportunityBrief"
                                    placeholder="Enter text here..." cols="30" rows="05"></textarea>
                        ...
                        <div class="form-group row">
                           <div class="col-lg-6 col-md-6 col-sm-12">
                                ...
                                <textarea class="form-control" type="text" name="PlatformInvestment"
                                    placeholder="Enter text here..." cols="20" rows="05"></textarea>
