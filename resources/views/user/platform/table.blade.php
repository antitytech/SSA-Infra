        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    ...
                    <h4 style="text-align: right"><a href="/add-platforms"
                                        ...
                                        <ul class="list-group list-group-flush">
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <li class="list-group-item" style="text-align: center"><a href="/view-my-platforms/{{ $platform->id }}" class="Platform_btn">View Platfrom</a></li>
                                                </div>
                                            </div>
                                        </ul>
                                    </div>
